...
#-----In there we try to build the relationship between i).environmental parameters and Seston FA and the ii). seston FA and phytoplankton biomass. (Seston FA determines by both factors; then we will do variation partitioning to identify the effect of environmental factors and phytoplankton biomass on seston FA)
...
Seston_FA_ENV[Seston_FA_ENV== 0] <- 0.0000001
...
###########################################################################################################
#2) Understand the relationship betweeen Seston FA and PB biomass
###########################################################################################################
...
Seston_FA_FA_phyto_dataframe<-(log_Seston_FA_phyto%>%filter(!Month=="May" & !Month=="June")%>%select(EPA:`ù6 PUFA`))
